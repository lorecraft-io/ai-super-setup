...
| `cbrain` | Launch Claude inside your 2ndBrain vault *(requires vault setup — see [2ndBrain-mogging](https://github.com/fidgetcoding/2ndBrain-mogging))* |
...
| Command | What it does |
|---------|-------------|
| `bash <(curl -fsSL https://raw.githubusercontent.com/fidgetcoding/cli-maxxing/main/update.sh)` | Re-run all steps, skip what is installed, pick up anything new |
